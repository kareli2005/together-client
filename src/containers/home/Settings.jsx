  ...
  return (
    <div className='w-full h-full rounded-xl flex flex-col justify-start items-center gap-4 home-container-enter'>
      <div className='flex flex-col sm:flex-row gap-4 w-full duration-300 justify-center items-center'>
        <div className='h-[160px] w-[160px] min-h-[160px] min-w-[160px] md:h-[220px] md:w-[220px] md:min-w-[220px] md:min-h-[220px] aspect-square flex rounded-xl overflow-hidden p-2 bg-white duration-300 relative shadow-lg shadow-gray-300'>
        ...
        <div className='flex w-full max-w-2/3 h-full flex-col gap-4 font-bold text-slate-500 text-sm sm:text-base md:text-lg duration-300'>
          <div className='bg-white px-6 py-4 rounded-xl h-full w-full flex justify-between items-center flex-wrap gap-2 shadow-lg shadow-gray-300'>
      ...
      <div className='w-full gap-4 font-bold text-slate-500 text-sm sm:text-base md:text-lg bg-white rounded-xl py-4 sm:py-6 px-6 flex justify-between items-start duration-300 shadow-lg shadow-gray-300'>
